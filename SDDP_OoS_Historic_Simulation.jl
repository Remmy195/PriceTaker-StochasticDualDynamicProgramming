...
function plot_scenarios(data, n_plot)
    ...
    gif(anim, "/projects/reak4480/Documents/Plots/SDDP_Historical/SDDP_animation.gif", fps = 3)
end
...
function static_price_plot(data, n_plot)
    ...
    Plots.savefig("/projects/reak4480/Documents/Plots/SDDP_Historical/static_price_plot.png")
end
...
function plot_reduced_scenarios(reduced_scenarios)
    ...
    Plots.savefig("/projects/reak4480/Documents/Plots/SDDP_Historical/reduced_scenario_histogram.png")
end
...
function simulate_with_closest_nodes(Ptaker, data, graph)
...
function analyze_and_plot_simulations(simulations, Ptaker, h_label)
    ...
    results_filepath = "/projects/reak4480/Documents/Results/SDDP_Model_Results/OoS_Historical_objective_values_and_confidence_interval_h$(h_label).txt"
    node_index_plot_path = "/projects/reak4480/Documents/Plots/SDDP_Historical/hourly_node_index_h$(h_label).png"
    price_noise_plot_path = "/projects/reak4480/Documents/Plots/SDDP_Historical/hourly_price_realizations_h$(h_label).png"
    spaghetti_plot_path = "/projects/reak4480/Documents/Plots/SDDP_Historical/SDDP_spaghetti_plot_h$(h_label).html"
    SOC_result = "/projects/reak4480/Documents/Results/SDDP_Model_Results/OoS_Historical_SOC_values_h$(h_label).txt"
    ...
    for (title, symbol) in [("Storage", :e_stored), ("Charge Energy", :e_charge), ("Discharge Energy", :e_discharge), ("Charge Decision", :z_charge), ("Discharge Decision", :z_discharge),("Energy Sold", :e_sold,), ("Energy Bought", :e_pur)]
        ...
        Plots.savefig("/projects/reak4480/Documents/Plots/SDDP_Historical/SDDP_$(replace(title, " " => "_"))_h$(h_label).png")
    end
end
...
for (h, bound) in zip(h_values, bounds)
    ...
    simulations = simulate_with_closest_nodes(Ptaker, data, graph)
